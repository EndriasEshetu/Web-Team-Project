  ...
  return (
    <div className="min-h-screen bg-[#0b1224] flex font-sans text-slate-200 antialiased">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-slate-900 relative overflow-hidden items-center justify-center border-r border-slate-900">
        <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1629909613654-28e377c37b09?auto=format&fit=crop&w=2000&q=80')] bg-cover bg-center mix-blend-overlay opacity-20"></div>
        ...
        <div className="relative z-10 max-w-lg text-center px-12 space-y-6 animate-fade-in">
          ...
          <p className="text-slate-400 text-lg leading-relaxed font-light">
            Securely access your clinical dashboard, view custom diagnostic reports, schedule appointments, and coordinate with clinical staff.
          </p>
          ...
          <div className="mt-8 p-4 rounded-2xl bg-teal-500/5 backdrop-blur-md border border-teal-500/10 text-left flex items-center gap-4 max-w-sm mx-auto shadow-lg">
            ...
            <div>
              <p className="text-white text-xs font-semibold uppercase tracking-wider">Clinical Workspace</p>
              <p className="text-slate-400 text-sm">24/7 Access to encrypted patient files.</p>
            </div>
          </div>
        </div>
        ...
        <div className="w-full max-w-md mx-auto space-y-8">
          <div className="text-center lg:text-left space-y-2">
            ...
            <p className="text-slate-400 text-sm">
              Please login with your secure credentials.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="space-y-1.5">
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  required
                  className="w-full pl-11 pr-4 py-3 bg-[#0e162a] border border-slate-800/80 rounded-xl focus:outline-none focus:border-teal-500 focus:ring-4 focus:ring-teal-500/10 text-white placeholder-slate-600 transition-all shadow-sm font-medium"
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  className="w-full pl-11 pr-11 py-3 bg-[#0e162a] border border-slate-800/80 rounded-xl focus:outline-none focus:border-teal-500 focus:ring-4 focus:ring-teal-500/10 text-white placeholder-slate-600 transition-all shadow-sm font-medium"
            ...
            {/* Login button matches the exact teal accent green button from original screenshot! */}
            <button
              type="submit"
              disabled={loginMutation.isPending}
              className="w-full py-3.5 font-extrabold text-slate-950 bg-teal-500 rounded-xl hover:bg-teal-400 focus:outline-none focus:ring-4 focus:ring-teal-500/20 active:scale-[0.98] disabled:opacity-70 disabled:active:scale-100 transition-all shadow-lg shadow-teal-500/10"
            >
